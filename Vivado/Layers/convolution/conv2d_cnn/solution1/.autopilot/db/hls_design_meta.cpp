...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("filt_address0", 5, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("filt_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("filt_q0", 32, hls_in, 1, "ap_memory", "mem_dout", 1),

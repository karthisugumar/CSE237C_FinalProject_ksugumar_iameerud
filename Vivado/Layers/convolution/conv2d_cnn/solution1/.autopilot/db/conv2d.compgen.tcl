...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename filt \
    op interface \
    ports { filt_address0 { O 5 vector } filt_ce0 { O 1 bit } filt_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'filt'"
}
}

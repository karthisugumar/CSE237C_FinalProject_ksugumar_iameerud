...
// ==============================================================
#ifndef __maxpool_fcmp_32nsbkb__HH__
#define __maxpool_fcmp_32nsbkb__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(maxpool_fcmp_32nsbkb) {
    ...
    SC_CTOR(maxpool_fcmp_32nsbkb):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);

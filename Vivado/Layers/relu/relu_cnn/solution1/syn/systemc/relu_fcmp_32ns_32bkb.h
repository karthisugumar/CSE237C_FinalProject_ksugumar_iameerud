...
// ==============================================================
#ifndef __relu_fcmp_32ns_32bkb__HH__
#define __relu_fcmp_32ns_32bkb__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(relu_fcmp_32ns_32bkb) {
    ...
    SC_CTOR(relu_fcmp_32ns_32bkb):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
